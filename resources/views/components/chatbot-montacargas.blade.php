                ...
                <div class="mb-4">
                    ...
                    <template x-if="message.role === 'bot'">
                        <div class="flex items-end gap-3">
                            ...
                            <div class="max-w-[280px] rounded-[18px] bg-[#f6f6f6] px-4 py-4 text-[16px] font-medium leading-7 text-slate-700 shadow-sm">
                                <span
                                ...
                                <template x-if="message.product && message.product.url">
                                    <div class="mt-4 overflow-hidden rounded-[16px] border border-slate-200 bg-white">
                                        <img
                                            :src="message.product.image || fallbackImage"
                                            :alt="message.product.title"
                                            class="h-36 w-full bg-slate-100 object-contain p-2"
                                        >
