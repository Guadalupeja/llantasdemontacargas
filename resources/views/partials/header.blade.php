<header class="sticky top-0 z-50 bg-white/90 backdrop-blur">
  <!-- ────────────────────── Barra superior (teléfonos/redes) ────────────────────── -->
  ...
  <a href="{{ url('/') }}" class="inline-flex items-center p-[10px]">
    <x-responsive-image
      :variants="image_variants(
        ...
        [320, 420],
        ['webp', 'png']   {{-- webp + fallback PNG --}}
      )"
      alt="Ruguex / Trelleborg"
      sizes="100vw"
      class="h-[38px] w-auto"   {{-- ajusta a tu altura deseada --}}
      fetchpriority="high"      {{-- logo = alta prioridad --}}
      loading="eager"           {{-- evita lazy para el logo --}}
    />
  </a>
</div>
      ...
      <div class="relative flex min-h-px basis-[87%] items-center">
        <div class="relative flex w-full items-center p-[10px]">
          ...
          <!-- 2) Botón hamburguesa mejorado (morph → X) -->
          <label for="nav-toggle"
            ...
            <span class="relative block h-5 w-6">
              <!-- barra 1 -->
              <span class="absolute left-0 top-0 h-[2px] w-6 bg-white transition-all duration-300
                           peer-checked:top-[10px] peer-checked:rotate-45"></span>
              <!-- barra 2 -->
              <span class="absolute left-0 top-[10px] h-[2px] w-6 bg-white transition-all duration-300
                           peer-checked:opacity-0"></span>
              <!-- barra 3 -->
              <span class="absolute left-0 bottom-0 h-[2px] w-6 bg-white transition-all duration-300
                           peer-checked:bottom-[10px] peer-checked:-rotate-45"></span>
            </span>
            <span class="text-[13px] font-semibold uppercase tracking-[1px] text-white">Menú</span>
          </label>

          <!-- 3) Overlay clicable para cerrar -->
          <label for="nav-toggle"
                 class="pointer-events-none fixed inset-0 z-[900] bg-black/50 opacity-0 transition
                        lg:hidden peer-checked:pointer-events-auto peer-checked:opacity-100"></label>
          ...
          <nav class="relative z-[1000] hidden w-full lg:block">
            <ul class="m-0 flex h-[56px] list-none items-center justify-between p-0">
              ...
              <li><a href="{{ url('/llantas-para-minicargadores') }}" class="flex h-[56px] items-center px-3 text-[15.5px] font-medium tracking-[-0.7px] text-white hover:text-white/80">Minicargadores</a></li>
              <li><a href="{{ url('/llantas-para-cargadores') }}" class="flex h-[56px] items-center px-3 text-[15.5px] font-medium tracking-[-0.7px] text-white hover:text-white/80">Cargadores</a></li>
              <li><a href="{{ url('/llantas-para-manipulador-telescopico') }}" class="flex h-[56px] items-center px-3 text-[15.5px] font-medium tracking-[-0.7px] text-white hover:text-white/80">Manipulador Telescópico</a></li>
          ...
          <!-- 5) Móvil (panel) -->
          <div id="mobile-nav"
               class="absolute left-0 right-0 top-full z-[1000] hidden origin-top scale-95 opacity-0
                      peer-checked:block peer-checked:scale-100 peer-checked:opacity-100 lg:hidden">
            <ul class="mx-2 mt-2 space-y-1 rounded-2xl border border-white/10 bg-black/80 p-2 text-white shadow-2xl backdrop-blur-md">
              <li>
                <a class="flex items-center gap-3 rounded-lg px-3 py-2 hover:bg-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30" href="{{ url('/') }}">
                  <i class="fa-solid fa-house text-white/70"></i> Inicio
                </a>
              </li>
              <li>
                <a class="flex items-center gap-3 rounded-lg px-3 py-2 hover:bg-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30" href="{{ url('/llantas-para-montacargas') }}">
                  <i class="fa-solid fa-truck-ramp-box text-white/70"></i> Montacargas
                </a>
              </li>
              <li>
                <a class="flex items-center gap-3 rounded-lg px-3 py-2 hover:bg-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30" href="{{ url('/llantas-para-minicargadores') }}">
                  <i class="fa-solid fa-screwdriver-wrench text-white/70"></i> Minicargadores
                </a>
              </li>
              <li>
                <a class="flex items-center gap-3 rounded-lg px-3 py-2 hover:bg-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30" href="{{ url('/llantas-para-cargadores') }}">
                  <i class="fa-solid fa-truck-loading text-white/70"></i> Cargadores
                </a>
              </li>
              <li>
                <a class="flex items-center gap-3 rounded-lg px-3 py-2 hover:bg-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30" href="{{ url('/llantas-para-manipulador-telescopico') }}">
                  <i class="fa-solid fa-arrows-up-down-left-right text-white/70"></i> Manipulador Telescópico
                </a>
              </li>
              <li>
                <a class="flex items-center gap-3 rounded-lg px-3 py-2 hover:bg-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30" href="{{ url('/tienda-en-linea') }}">
                  <i class="fa-solid fa-bag-shopping text-white/70"></i> Compra en línea
                </a>
              </li>
              <li>
                <a class="flex items-center gap-3 rounded-lg px-3 py-2 hover:bg-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30" href="{{ url('/rines-para-montacargas-y-cargadores') }}">
                  <i class="fa-solid fa-circle-notch text-white/70"></i> Rines para tu maquinaria
                </a>
              </li>
              ...
              <li class="pt-2">
                ...
                <ul class="space-y-1">
                  <li>
                    <a class="flex items-center gap-3 rounded-lg px-3 py-2 hover:bg-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30" href="{{ url('/somos') }}">
                      <i class="fa-solid fa-user-group text-white/70"></i> Quienes somos
                    </a>
                  </li>
                  <li>
                    <a class="flex items-center gap-3 rounded-lg px-3 py-2 hover:bg-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30" href="{{ url('/somos#trelleborg') }}">
                      <i class="fa-solid fa-industry text-white/70"></i> Acerca del fabricante
                    </a>
                  </li>
                </ul>
              </li>
              ...
              <li class="pt-2 grid grid-cols-2 gap-2">
                <a class="block rounded-lg bg-[#FF6000] px-3 py-2 text-center font-semibold hover:brightness-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30" href="{{ url('/blog-2') }}">Blog</a>
                <a class="block rounded-lg bg-white/10 px-3 py-2 text-center font-semibold hover:bg-white/15 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30" href="{{ url('/contacto') }}">Contacto</a>
              </li>
            </ul>
          </div>
          <!-- /Móvil -->
