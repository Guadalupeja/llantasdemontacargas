...
@section('title', 'portfolio · gear manufacturing | RUGUEX')
@section('meta_description', 'Página informativa: portfolio/gear manufacturing. Contáctanos para asesoría y cotizaciones.')
...
<section class="mx-auto max-w-[1140px] px-4 py-10">
  <h1 class="text-3xl font-semibold text-white bg-black inline-block px-3 py-2">{{ Str::of('portfolio/gear-manufacturing')->replace('-', ' ')->title() }}</h1>
