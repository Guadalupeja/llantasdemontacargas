...
@section('title', 'llantas solidas con arillo | RUGUEX')
@section('meta_description', 'Página informativa: llantas solidas con arillo. Contáctanos para asesoría y cotizaciones.')
...
<section class="mx-auto max-w-[1140px] px-4 py-10">
  <h1 class="text-3xl font-semibold text-white bg-black inline-block px-3 py-2">{{ Str::of('llantas-solidas-con-arillo')->replace('-', ' ')->title() }}</h1>
