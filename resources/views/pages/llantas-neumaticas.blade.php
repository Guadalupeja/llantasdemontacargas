...
@section('title', 'llantas neumaticas | RUGUEX')
@section('meta_description', 'Página informativa: llantas neumaticas. Contáctanos para asesoría y cotizaciones.')
...
<section class="mx-auto max-w-[1140px] px-4 py-10">
  <h1 class="text-3xl font-semibold text-white bg-black inline-block px-3 py-2">{{ Str::of('llantas-neumaticas')->replace('-', ' ')->title() }}</h1>
