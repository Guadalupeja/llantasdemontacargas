...
@section('title', 'blog 2 | RUGUEX')
@section('meta_description', 'Página informativa: blog 2. Contáctanos para asesoría y cotizaciones.')
...
<section class="mx-auto max-w-[1140px] px-4 py-10">
  <h1 class="text-3xl font-semibold text-white bg-black inline-block px-3 py-2">{{ Str::of('blog-2')->replace('-', ' ')->title() }}</h1>
